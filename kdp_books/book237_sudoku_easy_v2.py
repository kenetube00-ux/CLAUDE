"""Book 237: Large Print Sudoku - Easy Level Volume 2 (For Seniors)"""
import random
import os, sys
...
pdf.add_centered_text(500, "Easy Level Volume 2", font='F2', size=22)
...
# Copyright page
pdf.new_page()
pdf.add_centered_text(600, "LARGE PRINT SUDOKU - Easy Level Volume 2", font='F2', size=14)
...
pdf.add_text(72, 480, "- Start with rows, columns, or boxes that have the most numbers.", font='F1', size=12)
pdf.add_text(72, 455, "- Use pencil marks to note possible numbers for each empty cell.", font='F1', size=12)
pdf.add_text(72, 430, "- Look for cells where only one number can go.", font='F1', size=12)
...
pdf.save(os.path.join(os.path.dirname(os.path.abspath(__file__)), "Book237_Sudoku_Easy_V2.pdf"))
print("Book237_Sudoku_Easy_V2.pdf created successfully!")
