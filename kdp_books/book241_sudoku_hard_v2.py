"""Book 241: Large Print Sudoku - Hard Level Volume 2"""
import random
import os, sys
...
pdf.add_centered_text(500, "Hard Level Volume 2", font='F2', size=22)
pdf.add_centered_text(380, "30 Challenging Puzzles with Solutions", font='F1', size=16)
pdf.add_centered_text(330, "Test Your Skills", font='F1', size=14)
pdf.add_centered_text(100, "Daniel Tesfamariam", font='F2', size=14)

pdf.new_page()
pdf.add_centered_text(600, "LARGE PRINT SUDOKU - Hard Level Volume 2", font='F2', size=14)
...
pdf.add_text(72, 600, "Hard Level Tips:", font='F2', size=13)
pdf.add_text(72, 570, "- Use advanced techniques like X-Wings and Swordfish.", font='F1', size=12)
pdf.add_text(72, 545, "- Look for hidden triples and quads.", font='F1', size=12)
pdf.add_text(72, 520, "- Try coloring techniques for difficult eliminations.", font='F1', size=12)
pdf.add_text(72, 470, "Difficulty: HARD (22-27 numbers pre-filled)", font='F2', size=13)
...
pdf.save(os.path.join(os.path.dirname(os.path.abspath(__file__)), "Book241_Sudoku_Hard_V2.pdf"))
print("Book241_Sudoku_Hard_V2.pdf created successfully!")
