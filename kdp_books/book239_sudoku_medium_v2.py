"""Book 239: Large Print Sudoku - Medium Level Volume 2 (For Seniors)"""
import random
import os, sys
...
pdf.add_centered_text(500, "Medium Level Volume 2", font='F2', size=22)
pdf.add_centered_text(450, "(For Seniors)", font='F1', size=18)
pdf.add_centered_text(350, "30 Puzzles with Solutions", font='F1', size=16)
pdf.add_centered_text(300, "Challenge Your Mind Daily", font='F1', size=14)
pdf.add_centered_text(100, "Daniel Tesfamariam", font='F2', size=14)

# Copyright page
pdf.new_page()
pdf.add_centered_text(600, "LARGE PRINT SUDOKU - Medium Level Volume 2", font='F2', size=14)
...
pdf.add_text(72, 640, "Sudoku is a logic-based number puzzle:", font='F1', size=13)
pdf.add_text(72, 600, "1. Every row must contain digits 1-9 (no repeats).", font='F1', size=13)
pdf.add_text(72, 575, "2. Every column must contain digits 1-9 (no repeats).", font='F1', size=13)
pdf.add_text(72, 550, "3. Every 3x3 box must contain digits 1-9 (no repeats).", font='F1', size=13)
pdf.add_text(72, 510, "Medium Level Strategies:", font='F2', size=13)
pdf.add_text(72, 480, "- Use elimination within rows and columns.", font='F1', size=12)
pdf.add_text(72, 455, "- Look for naked pairs and pointing pairs.", font='F1', size=12)
pdf.add_text(72, 430, "- Scan each 3x3 box systematically.", font='F1', size=12)
...
pdf.save(os.path.join(os.path.dirname(os.path.abspath(__file__)), "Book239_Sudoku_Medium_V2.pdf"))
print("Book239_Sudoku_Medium_V2.pdf created successfully!")
