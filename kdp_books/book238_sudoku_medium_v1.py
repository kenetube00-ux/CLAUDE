"""Book 238: Large Print Sudoku - Medium Level Volume 1 (For Seniors)"""
import random
import os, sys
...
pdf.add_centered_text(500, "Medium Level Volume 1", font='F2', size=22)
pdf.add_centered_text(450, "(For Seniors)", font='F1', size=18)
pdf.add_centered_text(350, "30 Puzzles with Solutions", font='F1', size=16)
pdf.add_centered_text(300, "A Step Up in Challenge", font='F1', size=14)
pdf.add_centered_text(100, "Daniel Tesfamariam", font='F2', size=14)

# Copyright page
pdf.new_page()
pdf.add_centered_text(600, "LARGE PRINT SUDOKU - Medium Level Volume 1", font='F2', size=14)
...
pdf.add_text(72, 510, "Medium Level Tips:", font='F2', size=13)
pdf.add_text(72, 480, "- Use 'naked pairs' - two cells in a row/col that can only be two numbers.", font='F1', size=12)
pdf.add_text(72, 455, "- Look for 'hidden singles' in each 3x3 box.", font='F1', size=12)
pdf.add_text(72, 430, "- Scan rows and columns for elimination opportunities.", font='F1', size=12)
pdf.add_text(72, 360, "Difficulty: MEDIUM (28-33 numbers pre-filled)", font='F2', size=13)
...
pdf.save(os.path.join(os.path.dirname(os.path.abspath(__file__)), "Book238_Sudoku_Medium_V1.pdf"))
print("Book238_Sudoku_Medium_V1.pdf created successfully!")
