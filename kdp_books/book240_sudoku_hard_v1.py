"""Book 240: Large Print Sudoku - Hard Level Volume 1"""
import random
import os, sys
...
pdf.add_centered_text(500, "Hard Level Volume 1", font='F2', size=22)
pdf.add_centered_text(380, "30 Challenging Puzzles with Solutions", font='F1', size=16)
pdf.add_centered_text(330, "For Experienced Solvers", font='F1', size=14)
pdf.add_centered_text(100, "Daniel Tesfamariam", font='F2', size=14)

pdf.new_page()
pdf.add_centered_text(600, "LARGE PRINT SUDOKU - Hard Level Volume 1", font='F2', size=14)
...
pdf.add_text(72, 610, "1. Every row must contain digits 1-9 with no repeats.", font='F1', size=13)
pdf.add_text(72, 585, "2. Every column must contain digits 1-9 with no repeats.", font='F1', size=13)
pdf.add_text(72, 560, "3. Every 3x3 box must contain digits 1-9 with no repeats.", font='F1', size=13)
pdf.add_text(72, 510, "Hard Level Strategies:", font='F2', size=13)
pdf.add_text(72, 480, "- X-Wing and Swordfish patterns.", font='F1', size=12)
pdf.add_text(72, 455, "- Hidden pairs, triples, and quads.", font='F1', size=12)
pdf.add_text(72, 430, "- Coloring and forcing chains.", font='F1', size=12)
pdf.add_text(72, 380, "Difficulty: HARD (22-27 numbers pre-filled)", font='F2', size=13)
...
pdf.save(os.path.join(os.path.dirname(os.path.abspath(__file__)), "Book240_Sudoku_Hard_V1.pdf"))
print("Book240_Sudoku_Hard_V1.pdf created successfully!")
