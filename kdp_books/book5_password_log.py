...
def create_password_log_book():
    ...
    pdf.add_centered_text(230, "By", font='Helvetica', size=11)
    pdf.add_centered_text(207, "Daniel Tesfamariam", font='HelveticaBold', size=15)
    pdf.add_centered_text(160, "KEEP THIS BOOK IN A SAFE PLACE", font='HelveticaBold', size=11)
    pdf.add_rect(115, 150, 202, 25, line_width=1.5)
    pdf.add_centered_text(110, "This book belongs to:", font='Helvetica', size=12)
    ...
    pdf.add_centered_text(470, "By Daniel Tesfamariam", font='HelveticaBold', size=11)
    pdf.add_centered_text(440, "Copyright 2026 Daniel Tesfamariam. All Rights Reserved.", font='Helvetica', size=9)
    pdf.add_centered_text(418, "No part of this publication may be reproduced.", font='Helvetica', size=8)
    pdf.add_centered_text(390, "ISBN: _______________", font='Helvetica', size=9)
    pdf.add_centered_text(368, "Published via Amazon KDP", font='Helvetica', size=9)
    ...
    for letter in alphabet:
        for page_num in range(2):
            ...
            pdf.add_text(367, 617, letter, font='HelveticaBold', size=20)
            # Header
            ...
            pdf.add_centered_text(35, f"{letter}-{page_num + 1}", font='Helvetica', size=8)
