...
def create_password_log_book():
    ...
    pdf.add_centered_text(155, "By", font='Helvetica', size=11)
    pdf.add_centered_text(132, "Daniel Tesfamariam", font='HelveticaBold', size=15)
    pdf.add_centered_text(100, "This book belongs to:", font='Helvetica', size=12)
    pdf.add_line(130, 84, 302, 84, 0.8)
    ...
    pdf.add_centered_text(418, "No part of this publication may be reproduced without permission.", font='Helvetica', size=8)
